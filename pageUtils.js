...
const header = (req, res) => {
  ...
  res.write('<nav><ul><li><a href="/">トップ</a></li><li><a href="/users">ユーザ一覧</a></li><li><a href="/following">フォロー一覧</a></li><li><a href="/followed">フォロワー一覧</a></li><li><a href="/post">投稿</a></li><li><a href="/mypage">マイページ</a></li><li><a href="/sign_up">サインアップ</a></li><li><a href="/sign_in">ログイン</a></li></nav>');
